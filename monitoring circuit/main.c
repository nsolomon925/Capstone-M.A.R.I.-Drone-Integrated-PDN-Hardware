...
/* (12.6 V / 3S) Monitoring Circuit Values */
...
/* (16.8 V / 4S) Monitoring Circuit Values

#define GREEN_ON   14.2f
#define GREEN_OFF  14.0f

#define YELLOW_ON  13.2f
#define YELLOW_OFF 13.4f
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  // State Machine
	  if (battery_state == 2) // green
	  {
	      if (battery_voltage < GREEN_OFF)
	          battery_state = 1;
	  }
	  else if (battery_state == 1) // yellow
	  {
	      if (battery_voltage >= GREEN_ON)
	          battery_state = 2;
	      else if (battery_voltage < YELLOW_ON)
	          battery_state = 0;
	  }
	  else // red
	  {
	      if (battery_voltage >= YELLOW_OFF)
	          battery_state = 1;
	  }
